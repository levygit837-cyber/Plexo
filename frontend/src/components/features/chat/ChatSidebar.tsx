...
export const ChatSidebar = () => {
    ...
    return (
        <div className="flex flex-col w-[300px] h-full bg-plexo-bg-tertiary rounded-2xl p-5 gap-4">
            {/* Title */}
            ...
            <div className="relative">
                <input
                    ...
                    className="w-full px-4 py-3 bg-plexo-bg text-white placeholder-gray-500 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <svg
                ...
                {agents?.map((agent: Agent) => (
                    ...
                    >
                        <div className="relative">
                            ...
                            <div
                                className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-plexo-bg-tertiary ${getStatusColor(agent.status)}`}
                            />
                        </div>
