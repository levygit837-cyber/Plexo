...
export const ChatLayout = () => {
    return (
        <div className="flex flex-col h-screen bg-plexo-bg-light p-6">
            {/* Main Chat Container - equivalent to "Plexo Chat Components" frame */}
            <div className="flex flex-col flex-1 max-w-[1472px] mx-auto w-full bg-plexo-bg rounded-3xl p-6 gap-6">
                {/* Header Zone */}
                <ChatHeader />
