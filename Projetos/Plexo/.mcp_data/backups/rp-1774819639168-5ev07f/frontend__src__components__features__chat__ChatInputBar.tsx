...
export const ChatInputBar = () => {
    ...
    return (
        <div className="flex items-center h-[120px] bg-gray-900 rounded-2xl p-5 gap-4">
            {/* Composer */}
            <div className="flex items-center flex-1 h-full bg-gray-950 rounded-[18px] px-[18px] gap-4">
                {/* Attachment Button */}
